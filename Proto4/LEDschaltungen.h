...
public:
	...
	void hptaufRot();
	void hptaufGreen();
	//Hauptstraße gruen, der Rest hat rot:
	void standard();
...
void Led::strbhn()
{
	...
	delay(3000);
	digitalWrite(9, HIGH), digitalWrite(8, LOW); //Schaltet Weiß //deaktiviert Blau
	delay(5000);
	digitalWrite(8, HIGH), digitalWrite(9, LOW); //Schaltet Blau //deaktiviert Weiß
}
